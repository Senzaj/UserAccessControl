...
{
    /// <inheritdoc />
    public partial class AddRoleManagePermission : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("10000000-0000-0000-0000-000000000000"), "Manage", "Role" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("33333333-3333-3333-3333-333333333333"), "Read projects; read, create, update tasks", "Middle" },
                    { new Guid("44444444-4444-4444-4444-444444444444"), "Read, update tasks only", "Junior" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@example.com", "Admin", true, "User", "$2a$12$W0mAEZaXT04fCDArZAUgTuWXWgNDzLujpSdLPHc/aKNO9Wg9XIVh." },
                    { new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), new DateTime(2026, 2, 1, 0, 0, 0, 0, DateTimeKind.Utc), "senior@example.com", "Senior", true, "User", "$2a$12$/ZORaw1igN78hU7rng02De9X5addoVGiuzDS9KWW5AnNpfYiyimk." },
                    { new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), new DateTime(2026, 3, 1, 0, 0, 0, 0, DateTimeKind.Utc), "middle@example.com", "Middle", true, "User", "$2a$12$3ua2bja2pESTfGopHbluxOLC7xiEg7JawUonhCxka5u8CtxuWCP0S" },
                    { new Guid("dddddddd-dddd-dddd-dddd-dddddddddddd"), new DateTime(2026, 4, 1, 0, 0, 0, 0, DateTimeKind.Utc), "junior@example.com", "Junior", true, "User", "$2a$12$OOniy8OM1U6th0PebX95oODhjgvMe5m6bNsKf7DMDuRo6BPxkm3XG" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("10000000-0000-0000-0000-000000000000"), new Guid("11111111-1111-1111-1111-111111111111") },
